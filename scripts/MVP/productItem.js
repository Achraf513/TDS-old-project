...
var productItemView = /** @class */ (function () {
    ...
    productItemView.prototype.getDetailsBtn = function () { return this.detailsBtn; };
    productItemView.prototype.getRemoveBtn = function () { return this.removeBtn; };
    productItemView.prototype.getAddToCartBtn = function () { return this.addToCartBtn; };
    productItemView.prototype.setModel = function (_model) {
        ...
        */
        ...
        this.removeBtn.setAttribute("class", "removeBtn");
        ...
        rowPriceBtns.append(priceH2, this.detailsBtn, this.addToCartBtn, this.removeBtn);
    ...
    productItemView.prototype.addRemoveBtnHandler = function (handler) {
    ...
    function productItemPresenter(_view, _model) {
        ...
        _view.addAddToCartBtnHandler(function () {
            if (globalUser.getShopListP().getModel().getShopList()[_model.getId()] == undefined) {
                ...
                _view.getAddToCartBtn().hidden = true;
                _view.getRemoveBtn().hidden = false;
                //TO-DO : swap to a remove button!
            }
        });
        //TO-DO : remove btn css
        _view.addRemoveBtnHandler(function () {
            var shopItemP = globalUser.getShopListP().getModel().getShopList()[_model.getId()];
            globalUser.getShopListP().getModel().reduceTotalPrice(shopItemP.getModel().getTotalPrice());
            globalUser.getShopListP().getModel().removeFromShopList(shopItemP);
            globalUser.getShopListP().updateView();
            document.getElementById("shopList").append(globalUser.getShopListP().getView().getHtml());
            _view.getAddToCartBtn().hidden = false;
            _view.getRemoveBtn().hidden = true;
        });
